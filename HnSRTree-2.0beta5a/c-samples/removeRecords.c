 ...
 * $Id: removeRecords.c,v 1.9 2002/09/13 05:14:32 katayama Exp $
 */
...
static void removeRecords(const char *recordFileName, int maxCount,
...
main(int argc, char *argv[])
{
    ...
    removeRecords(recordFileName, maxCount, indexFileName, debug);
...
static void
removeRecords(const char *recordFileName, int maxCount,
	      const char *indexFileName, HnBool debug)
{
	...
	HnSRTreeFileSt_remove(indexFile, point, dataItem);
