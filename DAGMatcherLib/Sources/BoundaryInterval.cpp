...
void TBBInterval::SetLimits(int bndryLength)
{
	...
	const SkelPtCoord& b0p0 = pBranch0->getFirstXYPoint();
	const SkelPtCoord& b0pN = pBranch0->getLastXYPoint();

	const SkelPtCoord& b1p0 = pBranch1->getFirstXYPoint();
	const SkelPtCoord& b1pN = pBranch1->getLastXYPoint();

	const SkelPtBndryInfo& b0i0 = pBranch0->getFirstBndryInfo();
	const SkelPtBndryInfo& b0iN = pBranch0->getLastBndryInfo();

	const SkelPtBndryInfo& b1i0 = pBranch1->getFirstBndryInfo();
	const SkelPtBndryInfo& b1iN = pBranch1->getLastBndryInfo();
