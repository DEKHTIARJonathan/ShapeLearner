...
namespace odb
{
  ...
  const char access::view_traits_impl< ::GraphIdViewByGraphClass, id_pgsql >::
  query_statement_name[] = "query_GraphIdViewByGraphClass";

  bool access::view_traits_impl< ::GraphIdViewByGraphClass, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::GraphIdViewByGraphClass, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i)
  {
    using namespace pgsql;
  ...
  access::view_traits_impl< ::GraphIdViewByGraphClass, id_pgsql >::query_base_type
  access::view_traits_impl< ::GraphIdViewByGraphClass, id_pgsql >::
  ...
  result< access::view_traits_impl< ::GraphIdViewByGraphClass, id_pgsql >::view_type >
  access::view_traits_impl< ::GraphIdViewByGraphClass, id_pgsql >::
  query (database&, const query_base_type& q)
  {
    using namespace pgsql;
  ...
  const char access::view_traits_impl< ::GraphIdViewByObjectClass, id_pgsql >::
  query_statement_name[] = "query_GraphIdViewByObjectClass";

  bool access::view_traits_impl< ::GraphIdViewByObjectClass, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::GraphIdViewByObjectClass, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i)
  {
    using namespace pgsql;
  ...
  access::view_traits_impl< ::GraphIdViewByObjectClass, id_pgsql >::query_base_type
  access::view_traits_impl< ::GraphIdViewByObjectClass, id_pgsql >::
  query_statement (const query_base_type& q)
  {
    query_base_type r (
      "SELECT "
  ...
  result< access::view_traits_impl< ::GraphIdViewByObjectClass, id_pgsql >::view_type >
  access::view_traits_impl< ::GraphIdViewByObjectClass, id_pgsql >::
  query (database&, const query_base_type& q)
  {
    using namespace pgsql;
