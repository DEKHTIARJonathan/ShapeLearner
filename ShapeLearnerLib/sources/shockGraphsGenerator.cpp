...
shockGraphsGenerator::shockGraphsGenerator(const string& _filepath, const string& _objClass, const unsigned int& _jobID) : filepath(_filepath), objClass(_objClass), jobID(_jobID) {
	parametersInit();
