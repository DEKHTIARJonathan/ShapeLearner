...
class ShapeLearner
{
	public:
		...
		*/
		...
		/*!	
		*	\class ShapeLearner::CommonInterface
		...
		*/
		...
		private:
			...
			/* ************** Getters *********************/
			/*!
			*	\fn static boost::weak_ptr<Point> getPoint(const unsigned long keyDB) throw(ShapeLearnerExcept);
			...
			*/
			...
			/*!
			*	\fn static boost::weak_ptr<Node> getNode(const unsigned long keyDB) throw(ShapeLearnerExcept);
			...
			*/
			...
			/*!
			*	\fn static boost::weak_ptr<Edge> getEdge(const unsigned long keyDB) throw(ShapeLearnerExcept);
			...
			*/
			...
			/*!
			*	\fn static boost::weak_ptr<Graph> getGraph(const unsigned long keyDB) throw(ShapeLearnerExcept);
			...
			*/
			...
			/* ************** Getters & Setters ***********/
			/*!
			*	\fn static boost::weak_ptr<GraphClass> getGraphClass(const string& name, const bool isDirect = false, const bool isAcyclic = false) throw(ShapeLearnerExcept);
			...
			*/
			...
			/*!
			*	\fn static boost::weak_ptr<ObjectClass> getObjectClass(const string& name) throw(ShapeLearnerExcept);
	...
	private:
		...
		*/
		...
		/* ************* Memory Cleaners ****************/
		/*!
		*	\fn static bool removeObjectFromMap(boost::shared_ptr<Point> obj, bool cascade = false) throw (ShapeLearnerExcept);
		...
		*/
		...
		/*!
		*	\fn static bool removeObjectFromMap(boost::shared_ptr<Edge> obj, bool cascade = false) throw (ShapeLearnerExcept);
		...
		*/
		...
		/*!
		*	\fn static bool removeObjectFromMap(boost::shared_ptr<Node> obj, bool cascade = false) throw (ShapeLearnerExcept);
		...
		*/
		...
		/*!
		*	\fn static bool removeObjectFromMap(boost::shared_ptr<Graph> obj, bool cascade = false) throw (ShapeLearnerExcept);
		...
		*/
		...
		/*!
		*	\fn static bool removeObjectFromMap(boost::shared_ptr<GraphClass> obj, bool cascade = false) throw (ShapeLearnerExcept);
		...
		*/
		...
		/*!
		*	\fn static bool removeObjectFromMap(boost::shared_ptr<ObjectClass> obj, bool cascade = false) throw (ShapeLearnerExcept);
