...
*	\brief ShockGraphsReader Header
*	\version 1.0
*	\author Jonathan DEKHTIAR - contact@jonathandekhtiar.eu - @born2data - http://www.jonathandekhtiar.eu
*/

#ifndef _Shock_Graphs_Reader_
#define _Shock_Graphs_Reader_

#ifdef _MSC_VER
	#pragma message("Compiling ShapeLearnerLib::shockGraphsReader.h  - this should happen just once per project.\n")
#endif
...
public:
	...
	ShockGraphsReader(const string& _filepath, const string& _objClass, const unsigned int& _jobID);
	bool taskExecute();
