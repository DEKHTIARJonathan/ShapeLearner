...
#pragma message("Compiling ShapeLearnerLib/Include::constants.h - this should happen just once per project.\n")
...
namespace constants{
	...
	*/
	...
	/*!
	*	CConstant referencing to the Application's Core log.
	*/
