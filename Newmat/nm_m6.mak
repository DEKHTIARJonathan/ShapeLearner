...
# removing /Od /ZI
#CXXFLAGS = /nologo /D "WIN32" /D "_DEBUG" /D "_LIB" /Gm /GX /MDd /W3 /c /TP
#CXXFLAGS = /nologo /D "WIN32" /D "_DEBUG" /D "_LIB" /Gm /GX /MD /W3 /c /TP
#CXXFLAGS = /nologo -Duse_namespace /D "WIN32" /D "_DEBUG" /D "_LIB" /EHsc /MD /W3 /c /TP
...
tmtm.obj:      	tmtm.cpp newmat.h newmatio.h tmt.h include.h boolean.h myexcept.h
...
clean:
	cmd /C del /F /Q *.obj *.lib tmt example test_exc nl_ex sl_ex garch