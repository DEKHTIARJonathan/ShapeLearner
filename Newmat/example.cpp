...
void test1(Real* y, Real* x1, Real* x2, int nobs, int npred)
{
   ...
   // to get two columns
   std::cout << std::setw(11) << std::setprecision(5) << (A | SE) << std::endl;
...
void test2(Real* y, Real* x1, Real* x2, int nobs, int npred)
{
   ...
   std::cout << std::setw(11) << std::setprecision(5)  << a << " ";
   std::cout << std::setw(11) << std::setprecision(5)  << sqrt(v*ResVar) << std::endl;
   // make vector of standard errors
...
int main()
{
...

   {
      ...
      CatchAll { std::cout << Exception::what(); }
   }
   ...
   std::cout << "Checking for lost memory: "
