========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet timeTrick
========================================================================

AppWizard a créé cette application timeTrick pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application timeTrick.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé timeTrick.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
