...
#ifndef OBJECT_CLASS_ODB_HXX
#define OBJECT_CLASS_ODB_HXX
...
namespace odb
{
  ...
  struct query_columns< ::ObjectClass, id_pgsql, A >
  {
    ...
    pgsql::query_column<
      ...
      pgsql::id_string >
    objectClassName_type_;

    static const objectClassName_type_ objectClassName;
  };
    ...
    public access::object_traits< ::ObjectClass >
  {
    ...
    struct image_type
    {
      // objectClassName
      //
      details::buffer objectClassName_value;
      std::size_t objectClassName_size;
      bool objectClassName_null;
...
#include "ObjectClass-odb.ixx"

#include <odb/post.hxx>

#endif // OBJECT_CLASS_ODB_HXX
